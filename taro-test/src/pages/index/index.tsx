...
export default class Index extends Component<PropsWithChildren> {
  ...
  uploadSingleFile = (file, succ, err) => {
      ...
      header['token'] = "ey3JhbGciOiJIUllcyI6WyIxMjExMTEiLCI5MDAwMDQiLCIxMTk4MTQiLCIxMTMwMTEiLCIxMDAwMDQiLCIxMTMwNTEiLCIxMjE4MTQiLCIxMDAwMDgiXSwiaXNzIjoicGNuZy1zcnYtYXV0aCIsImF1ZCI6IndlYiIsImlhdCI6MTY3OTUzNTM5MSwiZXhwIjoxNjgwMzk5MzkxfQ.LlgV8loR8bTyWwcN4gPc-kDysugoQSuotKOIWW_G3RHfz8NsXvFKJvOVN7He5t7Pr-QYmcdZgmlwbi8ODsMzlQ"
